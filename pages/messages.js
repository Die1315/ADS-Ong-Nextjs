    ...
    return (
        <div>
            ...
            <div className="container mx-auto py-5 flex gap-5">
                <div className="w-8/12 flex flex-col gap-5 bg-white">
                        ...
                        <div className="min-w-full border rounded lg:grid lg:grid-cols-3">
                            <div className="border-r border-gray-300 lg:col-span-1">
                                ...
                                <ul className="overflow-auto h-[32rem]">
                                    ...
                                    <li>
                                        <a
                                            className="flex items-center px-3 py-2 text-sm border-b border-gray-300 cursor-pointer hover:bg-gray-100 focus:outline-none">
                                            <img className="object-cover w-10 h-10 rounded-full"
                                        ...
                                        <a
                                            className="flex items-center px-3 py-2 text-sm bg-gray-100 border-b border-gray-300 cursor-pointer focus:outline-none">
                                            <img className="object-cover w-10 h-10 rounded-full"
