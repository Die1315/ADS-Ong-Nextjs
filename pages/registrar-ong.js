        ...
        <div className="h-screen flex flex-col md:flex-row justify-center items-stretch columns-1 md:columns-2 py-5 md:py-0 bg-sm-register">
            <div className="static md:relative py-14 overflow-auto bg-white h-auto w-11/12 md:w-3/6 flex mx-auto flex-col justify-start items-center rounded-md md:rounded-none">
                <Image
                    ...
                    width="200"
                />
                <p className="w-5/6 md:w-4/6 my-5 text-center mx-auto">Registra tu ONG y ponte en contacto con la ayuda</p>
                <form className="w-5/6 md:w-4/6 flex flex-col justify-center items-stretch gap-5">
                    <div className="input-group flex flex-col md:flex-row justify-between items-center gap-3">
                        <input name="nombre" type="text" placeholder="Nombre ONG*" required className="w-full md:w-3/6" />
                        <input name="email" type="email" placeholder="Email ONG*" required className="w-full md:w-3/6" />
                    </div>
                    <div className="input-group flex flex-col md:flex-row justify-between items-center gap-3">
                        <input name="password" type="password" placeholder="Contraseña*" required className="w-full md:w-3/6" />
                        <input name="password" type="password" placeholder="Confirmar contraseña*" required className="w-full md:w-3/6" />
                    </div>
                    <input name="cif" type="number" placeholder="CIF ONG*" required />
                    <div className="input-group flex flex-col md:flex-row justify-between items-center gap-3">
                        <input name="facebook" type="url" placeholder="URL Facebook" className="w-full md:w-3/6" />
                        <input name="instagram" type="url" placeholder="URL Instagram" className="w-full md:w-3/6" />
                    </div>
                    <div className="input-group flex flex-col md:flex-row justify-between items-center gap-3">
