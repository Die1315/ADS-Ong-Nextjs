    ...
    <>
      {isLoading ? (
        ...
        <DashboardContext.Provider
          value={{ mostrarPostsList, setMostrarPostsList }}
        >
          ...
          <div className="container mx-auto px-2 md:px-0 py-5 flex flex-col md:flex-row gap-5">
            <div className="w-12/12 md:w-3/12 relative flex flex-col gap-5">
              <CardDashboard currentOng={currentOng} />
            </div>
            <div className="w-12/12 md:w-6/12 flex flex-col gap-5">
              {mostrarPostsList ? (
                <div className="flex justify-around items-center gap-1">
                  <button
                    onClick={handlePosts}
                    name="global"
                    className={`py-2 font-bold text-sm w-3/6 rounded-md ${
                      !typePosts
              ...
              {mostrarPostsList ? (
                ...
                <Project posts={posts} setPosts={setPosts} />
              )}
            </div>
