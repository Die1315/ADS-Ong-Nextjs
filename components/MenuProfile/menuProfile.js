  ...
  return (
    <div className="relative flex flex-col-reverse md:flex-row gap-5 md:gap-0 justify-between items-center w-full px-4 pb-4">
      <ul className="flex p-0 font-semibold">
        <li
          onClick={() => props.setActiveItem("Proyectos")}
          className={
            activeItem === "Proyectos"
              ? "active border-r border-gray-200 px-5 hover:underline focus-within:underline hover:cursor-pointer"
              : "border-r border-gray-200 px-5 hover:underline focus-within:underline hover:cursor-pointer"
          }
        >
          Proyectos
        </li>
        <li
          onClick={() => props.setActiveItem("Información")}
          className={
            activeItem === "Información"
              ? "active px-5  border-r border-gray-200  hover:underline focus-within:underline hover:cursor-pointer"
              : "border-r border-gray-200 px-5 hover:underline focus-within:underline hover:cursor-pointer"
          }
        >
          Información
        ...
        <li
          ...
          className={
            activeItem === "Conexiones"
              ? "active px-5 hover:underline focus-within:underline hover:cursor-pointer"
              : "px-5 hover:underline focus-within:underline hover:cursor-pointer"
          }
        >
          Conexiones
        </li>
      ...
      <div id="edit-profile" className="relative">
        { props.isOwner &&
          <button
            className={
              isOpen
                ? "bg-gray-400 font-bold rounded-full border border-gray-400 p-4 text-sm flex items-center justify-center gap-3"
                : "bg-light font-bold rounded-full border border-gray-200 p-4 text-sm flex items-center justify-center gap-3"
            }
            onClick={toggleMenu}
          >
